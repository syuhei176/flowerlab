...
var Process = function () {
  function Process(draw, rubberBand) {
    var _this = this;
    ...
    this.rect = draw.rect(this.width, this.height).attr({ fill: '#f0f0f0' });
    ...
    this.rect.mouseup(function () {
      ...
      if (_this.rubberband.dragging) {
        _this.rubberband.connect(_this);
      }
    });
    this.rect.mousemove(function (e) {
      if (_this.dragging) {
        _this.group.move(e.x - _this.width / 2, e.y - _this.height / 2);
        _this.update();
      }
    });
    arrow.mousedown(function () {
      _this.rubberband.dragging = true;
      _this.rubberband.source = _this;
    });
  }
  ...
  _createClass(Process, [{
    ...
    value: function highlight() {
      ...
      setTimeout(function () {
        _this2.rect.fill({ color: '#f0f0f0' });
      }, 1000);
    }
  }, {
    key: 'connect',
    value: function connect(destination) {
      var c = new _connection2.default(this.draw, this, destination);
    ...
    key: 'update',
    value: function update() {
      this.outputPorts.forEach(function (c) {
        c.update();
      });
    }
  }, {
...
},{"./connection":15}],4:[function(require,module,exports) {
"use strict";
...
var draw = (0, _svg2.default)('drawing').size(800, 500);
...
// ->("OK")
// ->("http response")
},{"svg.js":6,"./process":13}],16:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/6782ada10b9f5ed7e6742785303a4d5f.map